...
<div class="container" style="margin-top:65px">
        ...
        <div class="jumbotron text-center">
            <h1>Welcome to Zaman's Fashion</h1>
    ...
    <div class="row text-center" id="shirt">
        ...
        <div class="row text-center" id="shoes" >
            ...
            <div class="row text-center" id="headphones">
                    <div class="col-md-3 col-6 py-3" >
                        <div class="card">
                            <img src="images/N1.jpg" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Polo</h6>
                                <h6>Price :BDT 22,500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/N1.2.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Polo</h6>
                                <h6>Price :BDT 4500</h6>
                                <?php if (!isset($_SESSION['email'])) {?>
                    <p><a href="index.php#login" role="button" class="btn btn-warning  text-white ">Add To Cart</a></p>
                    <?php
                    } else {
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/N1.3.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Polo</h6>
                   ...
                   <?php
                    ...
                    <div class="col-md-3 col-6 py-3">
                        <div class="card">
                            <img src="images/N1.4.png" alt="" class="img-fluid pb-1">
                            <div class="figure-caption">
                                <h6>Polo</h6>
